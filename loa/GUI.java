...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuButton("Human vs AI->Auto White", this::autoWhite);
        addMenuButton("Human vs AI->Auto Black", this::autoBlack);
        addSeparator("Human vs AI");
        addMenuButton("Human vs AI->Manual White", this::manualWhite);
        addMenuButton("Human vs AI->Manual Black", this::manualBlack);
        addMenuButton("Help->Rules", this::help);
        ...
        add(_widget,
                new LayoutSpec("y", 1,
                        "height", 1,
                        "width", 3));
        addLabel("To move: YELLOW", "CurrentTurn",
    ...
    public void update(Game controller) {
        ...
        if (board.winner() != null) {
            String winner = board.winner().fullName();
