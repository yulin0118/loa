...
public class BoardTest {
    ...
    /** The initial position of board. */
    static final Piece[][] BOARD0 = {
    ...
    public void testThis() {
        Board b = new Board(BOARD0, BP);
        assertTrue("b1-d3", b.isLegal(mv("b1-d3")));
        b.makeMove(mv("b1-d3"));
        assertTrue("a3-d3", b.isLegal(mv("a3-d3")));
        b.makeMove(mv("a3-d3"));
        assertTrue("f1-a1", b.isLegal(mv("f1-a1")));
        b.makeMove(mv("f1-a1"));
    }
